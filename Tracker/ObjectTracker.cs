...
namespace Tracker
{
    public class ObjectTracker
    {
...
#if MY_DEBUG
                retResult.BackprojectFrame = backProjectMat.CvtColor(ColorConversionCodes.GRAY2BGR);
#endif
            }
        ...
        public class TrackResult : IDisposable
        {
...
#if MY_DEBUG
            public Mat BackprojectFrame { get; set; }
#endif
            public double RegionStdev { get; set; }
            ...
            public TrackResult(int x, int y, int width, int height, bool bTrackedWell, double regionStdev)
            {
                ...
                RegionStdev = regionStdev;
            }

            public TrackResult(Rect rect, bool bTrackedWell, double regionStdev)
            {
                X = rect.X;
                Y = rect.Y;
                Width = rect.Width;
